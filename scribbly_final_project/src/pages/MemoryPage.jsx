...
export default function MemoryPage({ addAction }) {
  const [activeGame, setActiveGame] = useState('sequence'); // sequence, match
  ...
  return (
    <div className="page-container">
      <div style={{ maxWidth: '900px', margin: '0 auto', display: 'grid', gridTemplateColumns: '250px 1fr', gap: '2rem' }}>
