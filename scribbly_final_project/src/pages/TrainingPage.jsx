...
export default function TrainingPage({ addAction }) {
  ...
  return (
    <div className="page-container">
      <div style={{ maxWidth: '1000px', margin: '0 auto', display: 'grid', gridTemplateColumns: '300px 1fr', gap: '2rem' }}>
        ...
        <section className="card" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <div style={{ position: 'relative', background: '#fff', borderRadius: '1.5rem', border: '2px solid var(--border-color)', height: '450px', overflow: 'hidden', boxShadow: '0 20px 25px -5px rgba(0,0,0,0.1)' }}>
            <canvas
              ref={canvasRef}
              width={700}
              height={450}
